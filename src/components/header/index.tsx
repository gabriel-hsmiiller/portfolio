    ...
    return (
        <StyledHeader display={display}>
            ...
            <div className='navigation'>
                <Link href="/home" className={router.asPath === '' || router.asPath === '/home' ? 'selected' : ''}>{translate('header.home')}</Link>
                <Link href="/portfolio" className={router.asPath === '/portfolio' ? 'selected' : ''}>{translate('header.portfolio')}</Link>
                <Link href="/contact" className={router.asPath === '/contact' ? 'selected' : ''}>{translate('header.contact')}</Link>
            </div>
        </StyledHeader>
    )
}
